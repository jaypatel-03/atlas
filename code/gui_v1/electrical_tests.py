...
qc_tool_template = "measurement-{test} -c ../configs/new_hw_config_{version}.json -m ../module-qc-database-tools/{loc_id}/{mod_sn}/{mod_sn}_L2_{lp_flag}{temp}.json"
...
qc_tests = ["iv_measure", "adc_calibration", "analog_readback", "sldo", "vcal_calibration", "injection_capacitance", "lp_mode", "data_transmission"]
...
if test == "lp_mode":
    lp_flag = "LP_"
elif test == "std_thresholdscan_zerobias":
